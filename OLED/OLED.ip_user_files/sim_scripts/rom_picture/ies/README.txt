...
#
# Generated by export_simulation on Wed Oct 15 15:33:33 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './rom_picture.sh' script.

./rom_picture.sh -reset_run
...
./rom_picture.sh -noclean_files

For more information on the script, please type './rom_picture.sh -help'.
